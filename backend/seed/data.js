...
const vataSchedule = [
  {
    ...
    exercises: [
      { name: 'Sun Salutations (Surya Namaskar)', duration: '20 mins', category: 'Yoga' },
      { name: 'Walking', duration: '15 mins', category: 'Cardio' }
    ]
  },
  {
    day: "Tuesday",
    ...
    exercises: [
      { name: 'Restorative Yoga', duration: '30 mins', category: 'Yoga' }
    ]
  },
  {
    day: "Wednesday",
    ...
    exercises: [
      { name: 'Tai Chi', duration: '30 mins', category: 'Yoga' },
      { name: 'Light Stretching', duration: '15 mins', category: 'Rest' }
    ]
  },
  {
    day: "Thursday",
    ...
    exercises: [
      { name: 'Yin Yoga', duration: '40 mins', category: 'Yoga' }
    ]
  },
  {
    day: "Friday",
    ...
    exercises: [
      { name: 'Dance / Movement', duration: '20 mins', category: 'Cardio' },
      { name: 'Meditation', duration: '10 mins', category: 'Rest' }
    ]
  },
  {
    day: "Saturday",
    ...
    exercises: [
      { name: 'Nature Walk', duration: '45 mins', category: 'Cardio' }
    ]
  },
  {
    day: "Sunday",
    ...
    exercises: [
      { name: 'Rest Day / Gentle Yoga', duration: '30 mins', category: 'Rest' }
    ]
  }
];
...
const pittaSchedule = [
  {
    ...
    exercises: [
      { name: 'Swimming', duration: '30 mins', category: 'Cardio' },
      { name: 'Cooling Pranayama (Sheetali)', duration: '10 mins', category: 'Yoga' }
    ]
  },
  {
    day: "Tuesday",
    ...
    exercises: [
      { name: 'Cycling', duration: '30 mins', category: 'Cardio' }
    ]
  },
  {
    day: "Wednesday",
    ...
    exercises: [
      { name: 'Team Sports (Soccer/Basketball)', duration: '45 mins', category: 'Cardio' }
    ]
  },
  {
    day: "Thursday",
    ...
    exercises: [
      { name: 'Hatha Yoga', duration: '30 mins', category: 'Yoga' }
    ]
  },
  {
    day: "Friday",
    ...
    exercises: [
      { name: 'Swimming / Water Aerobics', duration: '40 mins', category: 'Cardio' }
    ]
  },
  {
    day: "Saturday",
    ...
    exercises: [
      { name: 'Hiking (Moderate)', duration: '60 mins', category: 'Cardio' }
    ]
  },
  {
    day: "Sunday",
    ...
    exercises: [
      { name: 'Meditation / Relaxed Walk', duration: '30 mins', category: 'Rest' }
    ]
  }
];
...
const kaphaSchedule = [
  {
    ...
    exercises: [
      { name: 'Jogging', duration: '30 mins', category: 'Cardio' },
      { name: 'Vinyasa Yoga', duration: '20 mins', category: 'Yoga' }
    ]
  },
  {
    day: "Tuesday",
    ...
    exercises: [
      { name: 'HIIT Workout', duration: '20 mins', category: 'HIIT' }
    ]
  },
  {
    day: "Wednesday",
    ...
    exercises: [
      { name: 'Cycling / Spin Class', duration: '45 mins', category: 'Cardio' }
    ]
  },
  {
    day: "Thursday",
    ...
    exercises: [
      { name: 'Power Yoga', duration: '40 mins', category: 'Yoga' }
    ]
  },
  {
    day: "Friday",
    ...
    exercises: [
      { name: 'Running', duration: '30 mins', category: 'Cardio' }
    ]
  },
  {
    day: "Saturday",
    ...
    exercises: [
      { name: 'Circuit Training', duration: '45 mins', category: 'Strength' }
    ]
  },
  {
    day: "Sunday",
    ...
    exercises: [
      { name: 'Long Walk / Hike', duration: '60 mins', category: 'Cardio' }
    ]
  }
];
